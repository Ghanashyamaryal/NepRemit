        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl border border-neutral-200 shadow-sm p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-neutral-600">Start comparing rates in seconds</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      {passwordRequirements.map((req, i) => (
                        <div
                          ...
                          className={cn(
                            ...
                            req.test(password) ? "text-secondary-600" : "text-neutral-400"
                          )}
                        >
              ...
              <Button
                ...
                size="lg"
                className="w-full"
                disabled={isLoading || isGoogleLoading || !acceptTerms || password !== confirmPassword}
              >
                {isLoading ? (
                  <>
